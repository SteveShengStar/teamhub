...
const Grid = styled(SystemComponent)`
    ...
    ${theme.mediaQueries.mobile} {
        ...
        grid-template-columns: calc(${props =>
          props.leftColumnWidth} - 40px) auto;
    ...
    ${theme.mediaQueries.tablet} {
        ...
        grid-template-columns: 100%;
        grid-template-rows: ${props => props.leftColumnWidth} ${props =>
  props.leftColumnWidth};
    }
    ...
    @media screen and (min-width: 1320px) {
        ...
        grid-template-columns: calc(${props =>
          props.leftColumnWidth} - 20px) auto;
