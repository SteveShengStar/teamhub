...
7. Now, you can run all your typical npm commands. Please run `npm install`, `npm run dev`. Wait a few moments. You should get a message saying `Successfully Compiled ...`
